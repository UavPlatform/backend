...
public class UavManagementController {
    ...
    @Autowired
    private UavManagementService uavManagementService;
    ...
    public Result<Void> updateUavAvailable(@RequestParam String deviceId, @RequestParam Character isAvailable) {
        boolean updated = uavManagementService.updateUavAvailable(deviceId, isAvailable);
    ...
    public Result<List<Uav>> getAllUav() {
        List<Uav> uavs = uavManagementService.getUav();
    ...
    public Result<List<LiveUavVO>> getLiveUav() {
        List<LiveUavVO> liveUavList = uavManagementService.getLiveUav();
    ...
    public Result<Uav> getUavDetail(@RequestParam String deviceId) {
        Uav uav = uavManagementService.getUavByDeviceId(deviceId);
    ...
    public Result<AdminStatisticsVO> getStatistics() {
        AdminStatisticsVO statistics = uavManagementService.getAdminStatistics();
